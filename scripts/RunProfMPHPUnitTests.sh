...
docker exec sugar-web1 bash -c "cd custom/tests/unit-php/ && chmod +x ../../../vendor/bin/phpunit"
...
docker exec sugar-web1 bash -c "cd custom/tests/unit-php && ../../../vendor/bin/phpunit --testsuite custom"
